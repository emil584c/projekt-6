...
<template>
    <section class=" bg-cream-primary">
        <div class="flex flex-col items-start justify-center py-8 max-w-[330px] mx-auto md:flex-row md:max-w-content-width ">

                <div class="flex flex-col md:gap-10 md:flex-row-reverse md:justify-between">
                ...
                <div class="flex flex-col md:gap-10 md:flex-row md:justify-between">
