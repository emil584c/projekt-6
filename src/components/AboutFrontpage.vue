        ...
        <div class=" max-w-sm px-4 md:max-w-content-width mx-auto">
            ...
            <div class="flex flex-col gap-4 md:gap-10">
                ...
                <div class="flex flex-col gap-4 md:gap-10 md:flex-row md:justify-between">
                    ...
                    <div class=" bg-brown-primary md:bg-[url('../assets/images/placeholders/servicefoto.jpg')] bg-cover w-mobilebox-width h-mobilelongbox-height md:h-mobilebox-height bg-center flex flex-col p-10 md:w-full md:max-w-longbox-width">
