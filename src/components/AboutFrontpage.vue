        ...
        <div class=" max-w-sm px-4 md:px-0 md:max-w-content-width mx-auto">
            ...
            <div class="flex flex-col gap-4 md:gap-10">
                ...
                <div class="flex flex-col gap-4 md:gap-10 md:flex-row md:justify-between">
                    <div class="bg-[url('../assets/images/holdet_bag_carlsen_kvarter.jpg')] bg-cover w-mobilebox-width h-mobilebox-height bg-center flex justify-center items-end p-10 md:max-w-longbox-width md:w-full md:justify-end md:p-8">
                    ...
                    <div class="bg-[url('../assets/images/aabningstider_carlsens_kvarter.jpg')] bg-cover w-mobilebox-width h-mobilebox-height bg-center flex flex-col justify-center gap-6 pl-5 md:w-box-width">
                ...
                <div class="flex flex-col gap-4 md:gap-10 md:flex-row md:justify-between">
                    <div class="bg-[url('../assets/images/facade_carlsens_kvarter.jpg')] bg-cover w-mobilebox-width h-mobilebox-height bg-center flex flex-col justify-center gap-6 pl-5 md:w-box-width">
                    </div>
